...
- **Battery:** the advertised voltage (0.1 V steps) is mapped linearly over 2.5–3.0 V to **Battery** (%), and a **Battery Low** binary sensor turns on at **2.5 V or below** — below that, e-paper refresh becomes unreliable even though BLE still works.
